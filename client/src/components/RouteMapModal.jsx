    ...
    stops: [
      {
        ...
        description:
          "UNESCO World Heritage — the crown jewel of Manueline architecture",
    ...
    stops: [
      {
        ...
        icon: "warehouse",
        description:
          "Trendy creative hub in a historic 19th-century factory complex",
      ...
      },
      {
        ...
        icon: "explore",
        description:
          "Belém's iconic riverside tribute to Portugal's Age of Discovery",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Map */}
        <div
          className="flex-1 min-h-[200px] sm:min-h-[320px]"
          style={{ height: "min(420px, 50vh)", position: "relative" }}
        >
          <Map
            center={center}
            zoom={zoom}
